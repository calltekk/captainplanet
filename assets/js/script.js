...
$(document).ready(function() {
  ...
  var captainPlanet = $(".captain-planet-image");
  var rotationAngle = 0; // Variable to track the rotation angle
  ...
  // New Superpower - Rotate
  $(".rotate-button").on("click", function() {
    console.log("Rotate button clicked");

    // Increase the rotation angle for each click
    rotationAngle += 360;

    // Apply the rotation using CSS transform
    captainPlanet.css("transition", "transform 2s");
    captainPlanet.css("transform", "rotate(" + rotationAngle + "deg)");
  });
});
